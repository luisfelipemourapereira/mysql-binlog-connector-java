...
public class EventDeserializer {
  ...
  private EventData deserializeFormatDescriptionEventData(
  ...
  private EventData deserializeEventData(
  ...
  public enum CompatibilityMode {
    /**
     * Return DATETIME/DATETIME_V2/TIMESTAMP/TIMESTAMP_V2/DATE/TIME/TIME_V2 values as long|s (number
     * of milliseconds since the epoch (00:00:00 Coordinated Universal Time (UTC), Thursday, 1
     * January 1970, not counting leap seconds)) (instead of
